...
int main(int argc, char **argv)
{
  ...
  message_filters::Subscriber<sensor_msgs::Image> image_sub(nh, "image", 30);
  message_filters::Subscriber<geometry_msgs::PoseStamped> pose_sub(nh, "posestamped", 30);
  message_filters::Synchronizer<exact_policy> sync(exact_policy(100), image_sub, pose_sub);
