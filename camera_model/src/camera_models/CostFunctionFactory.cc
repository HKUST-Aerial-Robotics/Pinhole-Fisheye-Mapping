                                          ...
                                          int flags) const
{
    ...
    case CAMERA_INTRINSICS | CAMERA_POSE:
        ...
        case Camera::POLYFISHEYE:
            costFunction = new ceres::AutoDiffCostFunction<
              ReprojectionError1<PolyFisheyeCamera>, 2, FISHEYE_PARAMS_NUM, 4,
              3>(new ReprojectionError1<PolyFisheyeCamera>(observed_P,
                                                           observed_p));
            break;
        case Camera::FOV:
            costFunction = new ceres::AutoDiffCostFunction<
              ReprojectionError1<FovCamera>, 2, FOV_PARAM_NUM, 4,
              3>(new ReprojectionError1<FovCamera>(observed_P, observed_p));
            break;
        }
        break;
    case CAMERA_ODOMETRY_TRANSFORM | ODOMETRY_6D_POSE:
        ...
        case Camera::MEI:
            costFunction =
              new ceres::AutoDiffCostFunction<ReprojectionError1<CataCamera>, 2,
                                              4, 3, 3, 3>(
                new ReprojectionError1<CataCamera>(intrinsic_params, observed_P,
                                                   observed_p));
            break;
        case Camera::SCARAMUZZA:
            costFunction =
              new ceres::AutoDiffCostFunction<ReprojectionError1<OCAMCamera>, 2,
                                              4, 3, 3, 3>(
                new ReprojectionError1<OCAMCamera>(intrinsic_params, observed_P,
                                                   observed_p));
            break;
        case Camera::POLYFISHEYE:
            costFunction = new ceres::AutoDiffCostFunction<
              ReprojectionError1<PolyFisheyeCamera>, 2, 4, 3, 3, 3>(
              new ReprojectionError1<PolyFisheyeCamera>(
                intrinsic_params, observed_P, observed_p));
            break;
        case Camera::FOV:
            costFunction = new ceres::AutoDiffCostFunction<
              ReprojectionError1<FovCamera>, 2, 4, 3, 3, 3>(
              new ReprojectionError1<FovCamera>(
                intrinsic_params, observed_P, observed_p));
            break;
        }
        break;
...
ceres::CostFunction*
CostFunctionFactory::generateCostFunction(
  ...
  int flags) const
{
    ...
    case CAMERA_INTRINSICS | CAMERA_POSE:
        ...
        case Camera::POLYFISHEYE:
            costFunction = new ceres::AutoDiffCostFunction<
              ReprojectionError1<PolyFisheyeCamera>, 2, FISHEYE_PARAMS_NUM, 4,
              3>(new ReprojectionError1<PolyFisheyeCamera>(
              observed_P, observed_p, sqrtPrecisionMat));
            break;
        case Camera::FOV:
            costFunction = new ceres::AutoDiffCostFunction<
              ReprojectionError1<FovCamera>, 2, FOV_PARAM_NUM, 4,
              3>(new ReprojectionError1<FovCamera>(
              observed_P, observed_p, sqrtPrecisionMat));
            break;
        }
        break;
                                          ...
                                          bool optimize_cam_odo_z) const
{
    ...
    case CAMERA_POSE | POINT_3D:
        ...
        case Camera::POLYFISHEYE:
            costFunction = new ceres::AutoDiffCostFunction<
              ReprojectionError2<PolyFisheyeCamera>, 2, 4, 3, 3>(
              new ReprojectionError2<PolyFisheyeCamera>(intrinsic_params,
                                                        observed_p));
            break;
        case Camera::FOV:
            costFunction = new ceres::AutoDiffCostFunction<
              ReprojectionError2<FovCamera>, 2, 4, 3, 3>(
              new ReprojectionError2<FovCamera>(intrinsic_params, observed_p));
            break;
        }
        break;
    case CAMERA_ODOMETRY_TRANSFORM | ODOMETRY_3D_POSE | POINT_3D:
        ...
        case Camera::POLYFISHEYE:
            ...
            {
                costFunction = new ceres::AutoDiffCostFunction<
                  ReprojectionError3<PolyFisheyeCamera>, 2, 4, 3, 2, 1, 3>(
                  new ReprojectionError3<PolyFisheyeCamera>(intrinsic_params,
                                                            observed_p));
            }
            else
            {
                costFunction = new ceres::AutoDiffCostFunction<
                  ReprojectionError3<PolyFisheyeCamera>, 2, 4, 2, 2, 1, 3>(
                  new ReprojectionError3<PolyFisheyeCamera>(intrinsic_params,
                                                            observed_p));
            }
            break;
        case Camera::FOV:
            ...
            {
                costFunction = new ceres::AutoDiffCostFunction<
                  ReprojectionError3<FovCamera>, 2, 4, 3, 2, 1, 3>(
                  new ReprojectionError3<FovCamera>(intrinsic_params, observed_p));
            }
            else
            {
                costFunction = new ceres::AutoDiffCostFunction<
                  ReprojectionError3<FovCamera>, 2, 4, 2, 2, 1, 3>(
                  new ReprojectionError3<FovCamera>(intrinsic_params, observed_p));
            }
            break;
        }
    ...
    case CAMERA_ODOMETRY_TRANSFORM | ODOMETRY_6D_POSE | POINT_3D:
        ...
        case Camera::POLYFISHEYE:
            ...
            {
                costFunction = new ceres::AutoDiffCostFunction<
                  ReprojectionError3<PolyFisheyeCamera>, 2, 4, 3, 3, 3, 3>(
                  new ReprojectionError3<PolyFisheyeCamera>(intrinsic_params,
                                                            observed_p));
            }
            else
            {
                costFunction = new ceres::AutoDiffCostFunction<
                  ReprojectionError3<PolyFisheyeCamera>, 2, 4, 2, 3, 3, 3>(
                  new ReprojectionError3<PolyFisheyeCamera>(intrinsic_params,
                                                            observed_p));
            }
            break;
        case Camera::FOV:
            ...
            {
                costFunction = new ceres::AutoDiffCostFunction<
                  ReprojectionError3<FovCamera>, 2, 4, 3, 3, 3, 3>(
                  new ReprojectionError3<FovCamera>(intrinsic_params,
                                                            observed_p));
            }
            else
            {
                costFunction = new ceres::AutoDiffCostFunction<
                  ReprojectionError3<FovCamera>, 2, 4, 2, 3, 3, 3>(
                  new ReprojectionError3<FovCamera>(intrinsic_params,
                                                            observed_p));
            }
            break;
    ...
    case CAMERA_INTRINSICS | CAMERA_ODOMETRY_TRANSFORM | ODOMETRY_3D_POSE |
      POINT_3D:
        ...
        case Camera::POLYFISHEYE:
            ...
            {
                costFunction = new ceres::AutoDiffCostFunction<
                  ReprojectionError3<PolyFisheyeCamera>, 2, FISHEYE_PARAMS_NUM,
                  4, 3, 2, 1, 3>(
                  new ReprojectionError3<PolyFisheyeCamera>(observed_p));
            }
            else
            {
                costFunction = new ceres::AutoDiffCostFunction<
        ...
        case Camera::FOV:
            ...
            {
                costFunction = new ceres::AutoDiffCostFunction<
                  ReprojectionError3<FovCamera>, 2, FOV_PARAM_NUM,
                  4, 3, 2, 1, 3>(
                  new ReprojectionError3<FovCamera>(observed_p));
            }
            else
            {
                costFunction = new ceres::AutoDiffCostFunction<
    ...
    case CAMERA_ODOMETRY_TRANSFORM | ODOMETRY_6D_POSE | POINT_3D:
        ...
        case Camera::POLYFISHEYE:
            if (optimize_cam_odo_z)
            {
                costFunction = new ceres::AutoDiffCostFunction<
                  ReprojectionError3<PolyFisheyeCamera>, 2, 4, 3, 3, 3, 3>(
                  new ReprojectionError3<PolyFisheyeCamera>(
                    intrinsic_params, observed_p, sqrtPrecisionMat));
            }
            else
            {
        ...
        case Camera::FOV:
            if (optimize_cam_odo_z)
            {
                costFunction = new ceres::AutoDiffCostFunction<
                  ReprojectionError3<FovCamera>, 2, 4, 3, 3, 3, 3>(
                  new ReprojectionError3<FovCamera>(
                    intrinsic_params, observed_p, sqrtPrecisionMat));
            }
            else
            {
      ...
      POINT_3D:
        ...
        case Camera::POLYFISHEYE:
            if (optimize_cam_odo_z)
            {
                costFunction = new ceres::AutoDiffCostFunction<
                  ReprojectionError3<PolyFisheyeCamera>, 2, FISHEYE_PARAMS_NUM,
                  4, 3, 3, 3, 3>(new ReprojectionError3<PolyFisheyeCamera>(
            ...
            else
            {
                costFunction = new ceres::AutoDiffCostFunction<
                  ReprojectionError3<PolyFisheyeCamera>, 2, FISHEYE_PARAMS_NUM,
                  4, 2, 3, 3, 3>(new ReprojectionError3<PolyFisheyeCamera>(
                  observed_p, sqrtPrecisionMat));
            }
            break;
        case Camera::FOV:
            if (optimize_cam_odo_z)
            {
                costFunction = new ceres::AutoDiffCostFunction<
                  ReprojectionError3<FovCamera>, 2, FOV_PARAM_NUM,
                  4, 3, 3, 3, 3>(new ReprojectionError3<FovCamera>(
                  observed_p, sqrtPrecisionMat));
            }
            else
            {
                costFunction = new ceres::AutoDiffCostFunction<
                  ReprojectionError3<FovCamera>, 2, FOV_PARAM_NUM,
                  4, 2, 3, 3, 3>(new ReprojectionError3<FovCamera>(
                  observed_p, sqrtPrecisionMat));
            }
            break;
        }
                                          ...
                                          bool optimize_cam_odo_z) const
{
    ...
    case CAMERA_ODOMETRY_TRANSFORM | POINT_3D:
        ...
        case Camera::MEI:
            if (optimize_cam_odo_z)
            {
                costFunction = new ceres::AutoDiffCostFunction<
                  ...
                  new ReprojectionError3<CataCamera>(intrinsic_params, odo_pos,
                                                     odo_att, observed_p,
                                                     optimize_cam_odo_z));
            }
            else
        ...
        case Camera::SCARAMUZZA:
            if (optimize_cam_odo_z)
            {
                costFunction = new ceres::AutoDiffCostFunction<
                  ...
                  new ReprojectionError3<OCAMCamera>(intrinsic_params, odo_pos,
                                                     odo_att, observed_p,
                                                     optimize_cam_odo_z));
            }
            else
        ...
        case Camera::POLYFISHEYE:
            ...
            {
                costFunction = new ceres::AutoDiffCostFunction<
                  ReprojectionError3<PolyFisheyeCamera>, 2, 4, 3, 3>(
                  new ReprojectionError3<PolyFisheyeCamera>(
                    intrinsic_params, odo_pos, odo_att, observed_p,
                    optimize_cam_odo_z));
            }
            ...
            {
                costFunction = new ceres::AutoDiffCostFunction<
                  ReprojectionError3<PolyFisheyeCamera>, 2, 4, 2, 3>(
                  new ReprojectionError3<PolyFisheyeCamera>(
                    intrinsic_params, odo_pos, odo_att, observed_p,
                    optimize_cam_odo_z));
            }
        ...
        case Camera::FOV:
            ...
            {
                costFunction = new ceres::AutoDiffCostFunction<
                  ReprojectionError3<FovCamera>, 2, 4, 3, 3>(
                  new ReprojectionError3<FovCamera>(
                    intrinsic_params, odo_pos, odo_att, observed_p,
                    optimize_cam_odo_z));
            }
            ...
            {
                costFunction = new ceres::AutoDiffCostFunction<
                  ReprojectionError3<FovCamera>, 2, 4, 2, 3>(
                  new ReprojectionError3<FovCamera>(
                    intrinsic_params, odo_pos, odo_att, observed_p,
                    optimize_cam_odo_z));
            }
                                          ...
                                          int flags) const
{
    ...
    case POINT_3D:
        ...
        case Camera::MEI:
            costFunction =
              new ceres::AutoDiffCostFunction<ReprojectionError3<CataCamera>, 2,
                                              3>(
                new ReprojectionError3<CataCamera>(intrinsic_params, cam_odo_q,
        ...
        case Camera::SCARAMUZZA:
            costFunction =
              new ceres::AutoDiffCostFunction<ReprojectionError3<OCAMCamera>, 2,
                                              3>(
                new ReprojectionError3<OCAMCamera>(intrinsic_params, cam_odo_q,
                                                   cam_odo_t, odo_pos, odo_att,
                                                   observed_p));
            break;
        case Camera::POLYFISHEYE:
            costFunction = new ceres::AutoDiffCostFunction<
              ReprojectionError3<PolyFisheyeCamera>, 2, 3>(
              new ReprojectionError3<PolyFisheyeCamera>(
                intrinsic_params, cam_odo_q, cam_odo_t, odo_pos, odo_att,
                observed_p));
            break;
        case Camera::FOV:
            costFunction = new ceres::AutoDiffCostFunction<
              ReprojectionError3<FovCamera>, 2, 3>(
              new ReprojectionError3<FovCamera>(
                intrinsic_params, cam_odo_q, cam_odo_t, odo_pos, odo_att,
                observed_p));
            break;
  ...
  const Eigen::Vector2d& observed_p_r) const
{
    ...
    case Camera::POLYFISHEYE:
        costFunction = new ceres::AutoDiffCostFunction<
          StereoReprojectionError<PolyFisheyeCamera>, 4, FISHEYE_PARAMS_NUM,
          FISHEYE_PARAMS_NUM, 4, 3, 4, 3>(
          new StereoReprojectionError<PolyFisheyeCamera>(
            observed_P, observed_p_l, observed_p_r));
        break;
    case Camera::FOV:
        costFunction = new ceres::AutoDiffCostFunction<
          StereoReprojectionError<FovCamera>, 4, FOV_PARAM_NUM,
          FOV_PARAM_NUM, 4, 3, 4, 3>(
          new StereoReprojectionError<FovCamera>(
            observed_P, observed_p_l, observed_p_r));
        break;
    }
